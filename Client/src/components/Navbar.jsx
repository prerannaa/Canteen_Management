...
export default function Navbar() {
  return (
    <>
      <div className="flex items-strech justify-flex-start w-1/5 h-screen mr-7  bg-gray-50 ">
        <div className="flex flex-col items-left h-full p-5 overflow-hidden bg-white border-r border-black-700 text-gray-700">
          ...
          <div className="w-full px-2">
            <ul>
              <div className="flex flex-col items-center w-full mt-3 border-t border-gray-300">
                <div className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-200  hover:text-violet-700">
                  <svg
                ...
                <div className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-200  hover:text-violet-700">
                  ...
                  <CustomLink to="/customers">
                    <span className="ml-2 text-sm font-medium">Customers</span>
                  </CustomLink>
                </div>
                <div
                  className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-200 hover:text-violet-700"
                >
                  <svg
                    className="w-6 h-6 stroke-current"
                    xmlns="http://www.w3.org/2000/svg"
